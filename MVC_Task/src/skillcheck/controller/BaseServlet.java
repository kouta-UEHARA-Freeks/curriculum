...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_DESTINATION_RESULT_JSP = "/employee";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            eb.setEmpId(reqEmpId);
         	this.responseBean = this.ems.getEmployeeData(EmployeeDao.ExecuteCase.FIND_BY_EMPID, eb);
